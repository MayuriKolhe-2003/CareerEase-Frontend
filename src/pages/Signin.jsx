    ...
    <div class="max-sm:px-4">
      <div class="min-h-screen flex flex-col items-center justify-center">
        <div class="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
            ...
            <form>
              <div class="mb-12">
                ...
                <p class="text-sm mt-4 text-gray-800">Don't have an account  ? 
                  <Link to="/signup" class="textprimaryRed font-semibold hover:underline ml-1 whitespace-nowrap">Sign Up</Link>
                  </p>
              </div>
              ...
              <div>
                ...
                <div class="relative flex items-center">
                  <input name="email" type="text" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:borderprimaryRed pl-2 pr-8 py-3 outline-none" placeholder="Enter email" />
              ...
              <div class="mt-8">
                ...
                <div class="relative flex items-center">
                  <input name="password" type="password" required class="w-full text-gray-800 text-sm border-b border-gray-300 focus:borderprimaryRed pl-2 pr-8 py-3 outline-none" placeholder="Enter password" />
              ...
              <div class="flex flex-wrap items-center justify-end gap-4 mt-6">
                ...
                <div>
                  <a href="jajvascript:void(0);" class="textprimaryRed font-semibold text-sm hover:underline">
                    Forgot Password?
                  </a>
                </div>
              </div>
              ...
              <div class="mt-12">
                <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white bg-primaryRed  focus:outline-none">
                  Sign in
                </button>
              </div>
          ...
          <div class="w-full h-full flex items-center bg-dark rounded-xl p-8">
