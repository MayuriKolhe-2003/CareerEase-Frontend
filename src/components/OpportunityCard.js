...
const OpportunityCard = ({ data, type }) => (
  <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col w-full max-w-[280px] sm:max-w-[350px] h-auto flex-shrink-0">
    {/* Image */}
    <img src={data.image} alt={data.title} className="w-full h-32 sm:h-44 object-cover rounded-t-lg" />
